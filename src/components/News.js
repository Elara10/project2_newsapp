...
export default class News extends Component {
  ...
  render() {
    ...
    <div className="row">
        ...
        <NewsItem title="myTitle" description="mydesc" imageUrl="https://ichef.bbci.co.uk/live-experience/cps/624/cpsprodpb/10B48/production/_131742486_gettyimages-483386686-1.jpg" newsUrl="TODO"/>
        </div>
        <div className="col md-4">
