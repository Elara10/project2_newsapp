...
export class News extends Component{
  ...
  constructor(){
   ...
   async componentDidMount() {
    console.log("cdn");
    let url = "https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=fd5964b8ad4a4f5e9a3ee8d85e56895f&page=1&pageSize=20";
    ...
    handlePrevClick=async()=>{
     ...
     let url = `https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=fd5964b8ad4a4f5e9a3ee8d85e56895f&page=${this.state.page-1}&pageSize=20`;
    let data = await fetch(url);
    let parsedData = await data.json();
    console.log(parsedData);
    this.setState({
